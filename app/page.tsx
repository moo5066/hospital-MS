...
<button>
  <span className='bg-blue-600 p-3 rounded-lg text-center text-white duration-150 transition-transform hover:scale-105 shadow-md'>Login</span>
</button>
</div>
  ...
  <div >
    <h1 className='text-5xl font-bold'>Modern Hospital Management System</h1>
    <p className='text-gray-600 text-lg max-w-3xl'>Streamline your hospital operations with our comprehensive patient management platform. From appointments to emergency care, manage everything in one place.</p>
  </div>

<div className='flex gap-5 items-center'>
  <div className='bg-blue-600 couser-pointer  text-white p-5 text-xl font-bold flex items-center gap-2 w-max rounded-lg shadow-md duration-150 transition-transform hover:scale-105'>
  <Link href='/dashboard'>Access Dashboard</Link><span><HiOutlineArrowRight/></span></div>
  <Link href='/' className='couser-pointer border border-blue-600 text-blue-600 p-5 text-xl font-bold rounded-lg shadow-md duration-150 transition-transform hover:scale-105'>Learn More</Link>

</div>
</div>

<div className='mt-10 bg-white p-10 lg:w-[70%] rounded-lg shadow-lg'>
